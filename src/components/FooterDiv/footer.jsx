...
import { BsFacebook } from 'react-icons/bs';
 ...
 const Footer = () =>{
    return (
        <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[18px] gap[8] grid grid-cols-5 m-auto items-start justify-center '>
            ...
            <div>
                ...
                <p className='text-white pb-[13px] opacity-70 leading-7'>
                    we always make our seekers and companies find the best jobs and employers finf the best candidates
                </p>
            </div>
